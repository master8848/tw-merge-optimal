...
| Bundle size | 62.5 KB raw (~17 KB gzip) for the full grammar, independent of project size — see [size.md](size.md) | 3.4 KB small sample, ~15 KB corpus union, ~20 KB bench union (962 classes) |
